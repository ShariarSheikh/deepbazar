  ...
  return (
    <div className="flex-grow lg:pt-4 mt-7 lg:mt-0 sm:w-[30%] md:w-1/4">
      <div className="w-full">
        ...
        <div className="mt-7 w-full flex flex-col max-w-sm">
          <label className="text-gray-300 pb-1" htmlFor="Enter your email">
            Enter your email
          </label>
          <input
            type="text"
            placeholder="e.g.mail@gmail.com"
            className="py-2 px-2 outline-none rounded-sm"
          />
          <button className="py-2 px-3 mt-4 bg-yellow-500 text-white active:scale-105 duration-200">
            Subscribe
          </button>
        </div>
      </div>
