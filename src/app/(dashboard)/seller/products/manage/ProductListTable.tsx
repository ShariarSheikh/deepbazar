      ...
      <div className="w-full h-full overflow-x-auto border-t border-gray-200 pt-5 min-h-[300px]">
        ...
        {products.map(product => (
          <>
            <div
              key={product._id}
              className="min-w-[440px] flex start items-center justify-between w-full h-[45px] px-[18px] border-b border-gray-200 hover:bg-primaryLight group duration-150"
            >
              ...
              <div className="flex items-center">
                <div className="w-full min-w-[170px]">
                  <span
                    className={`font-semibold ${productStatusStyle(
                      product.status
                    )}`}
                  >
                    {product.status}
                ...
                <div className="relative w-full min-w-[118px] flex items-center">
                  ...
                  <AnimatePresence>
                    {showMenu && (
                      <ClickAwayListener
                        onClickAway={() => onMenuHandler(false)}
                      >
                        <motion.div
