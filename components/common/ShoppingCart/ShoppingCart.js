...
const ShoppingCart = ({ data }) => {
  ...
  return (
    <div
      className="bg-white relative md:w-[32%] lg:w-[24%] 2xl:min-w-[320px] max-w-xs w-[48%] h-[260px] xl:min-h-[380px] max-h-[380px]
    ...
    >
      <div className="w-full h-[180px] md:h-[290px] relative overflow-hidden p-2">
        <Link href={`/product/${pdEndpoint(title, id)}`} passHref>
          <img
